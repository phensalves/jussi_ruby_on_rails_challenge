...
feature 'Visitor search for an character' do
  scenario 'Successfully' do
    ...
    character2 = create(:character, name: 'Super-Man')
    visit root_path
    ...
    expect(page).not_to have_css('h3', text: character2.name)
  end
  ...
  VCR.use_cassette 'comics' do
    scenario 'and see the related comics' do
      ...
      expect(page).to have_css('h4', text: 'Avengers: The Initiative (2007) #18 (ZOMBIE VARIANT)')
      ...
      expect(page).to have_css('h4', text: 'Avengers: The Initiative (2007) #14 (SPOTLIGHT VARIANT)')
  ...
  scenario 'and cant find any results' do
    ...
    expect(page).not_to have_css('h1', text: "Search results for #{character.name}:")
